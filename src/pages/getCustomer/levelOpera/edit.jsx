        ...
        return <Root background={{ background: '#ffffff' }}>
            <View className='editLevel_container'>
                <View className='editLevel_caption_wrap'>
                    <NavBar title='编辑默认会员等级' iconType='zujian471' iconSize='60' iconColor='#ffffff' isCustom>
                    ...
                    <ScrollView className='editLevel_main_box' scrollY>
                        ...
                        <View className='ul'>
                            <View className='li flex font-3 border-bottom'>
                                ...
                                <View className='flex-shrink'>V3权益卡</View>
                            </View>
                            <View className='li flex border-bottom'>
                                <View className='flex1'>
                                    <View className='font-3'>获得条件</View>
                                    <View className='font-7'>首次需店家发出邀请或门店海报展示</View>
                                </View>
                                <View className='flex-shrink font-3'>邀请领取</View>
                            </View>
