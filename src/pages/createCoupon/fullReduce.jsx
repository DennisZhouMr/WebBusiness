            ...
            <View className='second-page_container'>
                ...
                <View className='second-page_main_wrap'>
                    <ScrollView className='second-page_main_box form-container' scrollY>
                        <View className='form-tit'>满减</View>
                        <View className='form-desc'>例：满100减20元</View>
                        <AtForm>
                            ...
                            <View className='form-item no-flex'>
                                <View className='form-label'>满减规则</View>
                                ...
                                <View className='form-price'>
                                    ...
                                    <Text>元减</Text>
                                    <AtInput className='no-auto-full' name='reduce-price' type='digit' value={0} />
                                    <Text>元</Text>
                                </View>
                            </View>
                            <View className='form-item last' style={{ justifyContent: 'center' }}>
